...
@section('content')
    ...
    <head>
        ...
        <title>Consulta de Predios</title>
        <style>
            body {
    ...
    <body>
        ...
        <div class="card">
            ...
            <button class="button" style="background-color: blue">Buscar por</button>
            <button class="button" style="background-color:  red">Nueva Clave</button>
            ...
            <div id="condonaciones" class="cards" style="max-width: 1800px; max-height: auto; overflow: auto;">
                <h2>Condonaciones</h2>
                <h2><strong>Aplicación de Accesorios</strong></h2>
                <div class="form-group" style="display: flex; align-items: center; margin-top: 20px;">
                    <input type="checkbox" id="gastosEjecucion" class="form-control" style="width: 25px; height: 20px;">
                    <label for="gastosEjecucion" style="margin-right: 10px;">Aplicar Gastos de Ejecución?</label>
                </div>
                <div>
                    <input type="checkbox" id="gastosEmbargo" class="form-control" style="width: 25px; height: 20px;">
                    <label for="gastosEmbargo" style="margin-right: 10px;">Aplicar Gastos de Embargo?</label>
                </div>
                <div style="margin-bottom: 20px">
                    <input type="checkbox" id="multas" class="form-control" style="width: 25px; height: 20px;">
                    <label for="multas" style="margin-right: 10px;">Aplicar Multas?</label>
                </div>

                <h2><strong>Condonaciones por Aplicar</strong></h2>
                <div style="display: flex; margin-top: 20px; margin-bottom: 40px">

                    <!-- Primer div: Porcentajes de Descuento -->
                    <div style="flex: 1; margin-right: 10px;">
                        <div style="display: flex; align-items: center; margin-bottom: 10px;">
                            <label style="margin-right: 10px;">% Descuentos Impuestos:</label>
                            <input type="text" class="form-control" style="width: 50%; text-align: center" placeholder="0.000">
                        </div>
                        <div style="display: flex; align-items: center; margin-bottom: 10px;">
                            <label style="margin-right: 10px;">% Descuentos Actualización:</label>
                            <input type="text" class="form-control" style="width: 50%; text-align: center" placeholder="0.000">
                        </div>
                        <div style="display: flex; align-items: center; margin-bottom: 10px;">
                            <label style="margin-right: 10px;">% Descuentos Recargos:</label>
                            <input type="text" class="form-control" style="width: 50%; text-align: center" placeholder="0.000">
                        </div>
                        <div style="display: flex; align-items: center; margin-bottom: 10px;">
                            <label style="margin-right: 10px;">% Descuentos Gastos:</label>
                            <input type="text" class="form-control" style="width: 50%; text-align: center" placeholder="0.000">
                        </div>
                        <div style="display: flex; align-items: center;">
                            <label style="margin-right: 10px;">% Descuentos Multas:</label>
                            <input type="text" class="form-control" style="width: 50%; text-align: center" placeholder="0.000">
                        </div>
                    </div>
                    ...
                    <div style="flex: 1; margin-right: 10px;">
                        <div style="display: flex; align-items: center; margin-bottom: 10px;">
                            <label style="margin-right: 10px;">Aplicar desde bimestre:</label>
                            <input type="text" class="form-control" style="width: 50%; text-align: center" placeholder="0.000">
                        </div>
                        <div style="display: flex; align-items: center; margin-bottom: 10px;">
                            <label style="margin-right: 10px;">Aplicar desde bimestre:</label>
                ...
                <div style="display: flex;margin-top: 20px;">
                    ...
                    <div style="display: flex; gap: 10px;">
                        <button style="background-color: blue; color: white; border: none; padding: 10px 20px; cursor: pointer;">Crear</button>
                        <button style="background-color: blue; color: white; border: none; padding: 10px 20px; cursor: pointer;">Aplicar</button>
                        <button style="background-color: blue; color: white; border: none; padding: 10px 20px; cursor: pointer;">Guardar</button>
                    </div>
                    <!-- Botón Amarillo -->
                    <button style="background-color: yellow; color: black; border: none; padding: 10px 20px; cursor: pointer;">Cancelar</button>
                </div>
            </div>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                    <thead>
                        <tr>
                            <th style="border: 1px solid #ddd; padding: 8px;">No.</th>
                            <th style="border: 1px solid #ddd; padding: 8px;">Fecha</th>
                            <th style="border: 1px solid #ddd; padding: 8px;">Movimiento</th>
                    ...
                    <tbody>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;">1</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">20204/10/18</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">AVALUO</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Yo</td>
                        </tr>
                        <!-- Puedes añadir más filas aquí -->
                    </tbody>
                </table>
